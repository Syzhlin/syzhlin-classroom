      ...
      <div className="sz-widget rounded-3xl p-4 space-y-3" style={{ backgroundColor: 'var(--sz-card-pastel)' }}>
        ...
        {previewUrl ? (
          ...
          <button
            ...
            className="w-full h-28 rounded-2xl flex flex-col items-center justify-center gap-2 border-2 border-dashed transition-colors"
          ...
          >
            ...
            <span className="text-xs font-medium" style={{ color: 'var(--sz-text-muted)' }}>사진 첨부</span>
          </button>
        )}
        ...
        {done ? (
          ...
          <button
            ...
            className="w-full py-3 rounded-2xl text-sm font-semibold text-white flex items-center justify-center gap-2 disabled:opacity-40 transition-opacity"
